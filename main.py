...
def run():
  ...
  print(f"Gradepoint for course 1 is: {getGradePoint(grade)}")
  #
  ...
  print(f"Gradepoint for course 2 is: {getGradePoint(grade)}")
  #
  grade = input("Enter your course 3 grade letter: ")
  gradepoint3 = getGradePoint(grade)
  credit3 = float(input("Enter your course 3 credit: "))
  print(f"Gradepoint for course 3 is: {getGradePoint(grade)}")
  #
